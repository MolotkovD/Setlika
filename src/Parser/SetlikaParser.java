...
public class SetlikaParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, NUMBER=41, ID=42, SCOL=43, WS=44;
	public static final int
		...
		RULE_integer = 30, RULE_float = 31, RULE_text = 32, RULE_identifier = 33;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"binary_operator", "literal", "integer", "float", "text", "identifier"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, "NUMBER", "ID", "SCOL", "WS"
		};
	}
	...
	public final StmtContext stmt() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8796093023430L) != 0)) {
				{
				{
				setState(68);
				sql_stmt_list();
